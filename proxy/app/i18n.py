...
from app.config import DEFAULT_LANGUAGE, I18N_ENABLED, SUPPORTED_LANGUAGES as CONFIG_SUPPORTED_LANGUAGES

logger = logging.getLogger(__name__)

SUPPORTED_LANGUAGES: set[str] = set(CONFIG_SUPPORTED_LANGUAGES) if isinstance(CONFIG_SUPPORTED_LANGUAGES, list) else {"en", "ru", "de", "fr", "zh"}
...
_DE_COMMON_WORDS = {
    "und", "ein", "eine", "der", "die", "das", "ist", "nicht", "mit", "von",
    "für", "auf", "ich", "wir", "sie", "was", "wie", "wo", "sind", "aus",
    "wird", "werden", "wurde", "wenn", "auch", "noch", "schon", "diese",
    "durch", "über", "nach", "vor", "bei", "ab", "seit", "dass", "oder",
    "aber", "sich", "einen", "dem", "den", "des", "im", "am", "um", "zum",
    "zur", "kein", "keine", "mehr", "als", "nur",
}

_FR_COMMON_WORDS = {
    "est", "vous", "dans", "avec", "pour", "sur", "comment", "quelle",
    "sont", "nous", "ils", "elles", "leur", "leurs", "comme", "cette",
    "aussi", "tout", "tous", "toute", "toutes", "faire", "peut", "être",
    "avoir", "entre", "deux", "même", "autre", "autres", "sans", "mais",
    "donc", "encore", "toujours", "ainsi", "alors", "peuvent", "doit",
    "doivent", "depuis", "rendre", "pendant", "avant", "après", "entre",
    "celui", "celle", "ceux", "celles", "certains", "certaines",
    "votre", "notre", "notre", "sera", "seront", "étaient", "était",
    "moins", "plus", "très", "bien", "faire", "dire", "mettre",
    "nouveau", "nouvelle", "nouveaux", "premier", "première",
}
...
SYSTEM_PROMPTS: dict[str, str] = {
    ...
    "ru": (
        ...
        "Если контекст не содержит достаточно информации, чётко скажите об этом. "
    ...
    "fr": (
        ...
        "Répondez aux questions de l'utilisateur en utilisant uniquement le contexte fourni. "
...
FALLBACK_MESSAGES: dict[str, str] = {
    "en": "I don't have enough information to answer this question. Please try rephrasing or check the source documents.",
    "ru": "У меня недостаточно информации, чтобы ответить на этот вопрос. Пожалуйста, переформулируйте запрос или проверьте исходные документы.",
    "de": "Ich habe nicht genügend Informationen, um diese Frage zu beantworten. Bitte versuchen Sie, die Frage umzuformulieren, oder überprüfen Sie die Quelldokumente.",
    "fr": "Je ne dispose pas d'assez d'informations pour répondre à cette question. Veuillez reformuler ou vérifier les documents sources.",
