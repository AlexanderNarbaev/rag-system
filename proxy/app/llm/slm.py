...
INTENT_COMPLEXITY_MAP: dict [IntentType, int] = {
    IntentType.GREETING: 1, IntentType.SIMPLE_FACT: 3, IntentType.FACTUAL: 5, IntentType.PROCEDURAL: 7,
    IntentType.COMPARISON: 8, IntentType.SUMMARIZATION: 6, IntentType.COMPLEX: 10, IntentType.UNKNOWN: 5,
}
  ...
  def _ensure_server_running (self) -> None:
    ...
    with self._lock:
      ...
      self._process = subprocess.Popen ([
          ...
          str (self._threads),
      ], stdout = subprocess.DEVNULL, stderr = subprocess.DEVNULL, # Detach from the parent process group so signals
...
def score_query_complexity (query: str) -> int:
  ...
  comparison_words = [
      ...
      "pros", "cons", "альтернатив", "alternative",
  ]
...
_NON_EN_GREETING_PATTERNS = {
    ...
    "fr": ["bonjour", "bonsoir", "salut", "coucou", "hello", "hi"], "zh": ["你好", "您好", "嗨", "哈喽"],
}
