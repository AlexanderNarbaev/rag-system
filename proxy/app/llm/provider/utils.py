...
async def stream_completion (
    ...
    provider_type: str | None = None, ) -> AsyncIterator [dict [str, Any]]:
  router = get_router ()
  async for chunk in router.stream_completion (messages, temperature, max_tokens, provider_type = provider_type, ):
    yield chunk
...
async def non_stream_completion (
  ...
  router = get_router ()
  return await router.non_stream_completion_text (messages, temperature, max_tokens, provider_type = provider_type, )
...
def non_stream_completion_sync (
    ...
    provider_type: str | None = None, ) -> str:
  router = get_router ()
  return router.non_stream_completion_sync (messages, temperature, max_tokens, provider_type = provider_type, )
