...
from app.config import HYDE_ENABLED, MAX_CHUNKS_RETRIEVAL
from app.retrieval import embedder, hybrid_search
...
def hyde_search(
    ...
    try:
        ...
        from app.retrieval import COLLECTION_NAME, QDRANT_HOST, QDRANT_PORT, qdrant_client
