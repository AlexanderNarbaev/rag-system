    ...
    if EMBEDDER_ENDPOINT:
        ...
        if EMBEDDER_FALLBACK_LOCAL:
            ...
            raise ConnectionError(
                f"Remote embedder at {EMBEDDER_ENDPOINT} is unreachable "
                f"and EMBEDDER_FALLBACK_LOCAL is false."
            )
...
def create_reranker() -> Any:
    ...
    if RERANKER_ENDPOINT:
        ...
        if RERANKER_FALLBACK_LOCAL:
            ...
            raise ConnectionError(
                f"Remote reranker at {RERANKER_ENDPOINT} is unreachable "
                f"and RERANKER_FALLBACK_LOCAL is false."
            )
