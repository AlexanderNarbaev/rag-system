...
FALLBACK_MESSAGES: dict[str, str] = {
    "en": "I don't have enough information to answer this question. Please try rephrasing or check the source documents.",  # noqa: E501
    "ru": "У меня недостаточно информации, чтобы ответить на этот вопрос. Пожалуйста, переформулируйте запрос или проверьте исходные документы.",  # noqa: E501
    "de": "Ich habe nicht genügend Informationen, um diese Frage zu beantworten. Bitte versuchen Sie, die Frage umzuformulieren, oder überprüfen Sie die Quelldokumente.",  # noqa: E501
    "fr": "Je ne dispose pas d'assez d'informations pour répondre à cette question. Veuillez reformuler ou vérifier les documents sources.",  # noqa: E501
