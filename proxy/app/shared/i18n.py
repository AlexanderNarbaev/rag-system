...
SUPPORTED_LANGUAGES: set [str] = (
    set (CONFIG_SUPPORTED_LANGUAGES) if isinstance (CONFIG_SUPPORTED_LANGUAGES, list) else {
        "en", "ru", "de", "fr", "zh"
    })  # noqa: E501
...
_DE_COMMON_WORDS = {
    "und", "ein", "eine", "der", "die", "das", "ist", "nicht", "mit", "von", "für", "auf", "ich", "wir", "sie", "was",
    "wie", "wo", "sind", "aus", "wird", "werden", "wurde", "wenn", "auch", "noch", "schon", "diese", "durch", "über",
    "nach", "vor", "bei", "ab", "seit", "dass", "oder", "aber", "sich", "einen", "dem", "den", "des", "im", "am", "um",
    "zum", "zur", "kein", "keine", "mehr", "als", "nur",
}

_FR_COMMON_WORDS = {
    "est", "vous", "dans", "avec", "pour", "sur", "comment", "quelle", "sont", "nous", "ils", "elles", "leur", "leurs",
    "comme", "cette", "aussi", "tout", "tous", "toute", "toutes", "faire", "peut", "être", "avoir", "entre", "deux",
    "même", "autre", "autres", "sans", "mais", "donc", "encore", "toujours", "ainsi", "alors", "peuvent", "doit",
    "doivent", "depuis", "rendre", "pendant", "avant", "après", "celui", "celle", "ceux", "celles", "certains",
    "certaines",  # noqa: E501
    "votre", "notre", "sera", "seront", "étaient", "était", "moins", "plus", "très", "bien", "dire", "mettre",
...
SYSTEM_PROMPTS: dict [str, str] = {
    "en": ("You are a helpful corporate knowledge assistant. "
           "Answer the user's question using only the provided context. "
           "If the context does not contain enough information, say so clearly. "
           "Always cite your sources."), "ru": ("Вы — корпоративный ассистент по базе знаний. "
    ...
    "de": ("Sie sind ein hilfreicher Assistent für die Wissensdatenbank des Unternehmens. "
           ...
           "Geben Sie immer Ihre Quellen an."), "fr": ("Vous êtes un assistant de base de connaissances d'entreprise. "
                                                       ...
                                                       "dites-le clairement. "
                                                       "Citez toujours vos sources."), "zh": ("您是企业知识库助手。"
                                                                                              "仅使用提供的上下文回答用户的问题。"
                                                                                              "如果上下文包含的信息不足，请明确说明。"
                                                                                              "请始终注明信息来源。"),
}
