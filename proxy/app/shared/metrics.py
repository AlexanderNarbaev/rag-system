...
rag_ragas_faithfulness: Any = _reuse_metric("rag_ragas_faithfulness", Gauge) or Gauge(
    "rag_ragas_faithfulness",
    "RAGAS faithfulness score (NLI-based claim verification, 0.0-1.0)",
)

rag_ragas_relevancy: Any = _reuse_metric("rag_ragas_relevancy", Gauge) or Gauge(
    "rag_ragas_relevancy",
    "RAGAS answer relevancy score (embedding cosine similarity, 0.0-1.0)",
)

rag_ragas_precision: Any = _reuse_metric("rag_ragas_precision", Gauge) or Gauge(
    "rag_ragas_precision",
    "RAGAS context precision score (fraction of contexts used, 0.0-1.0)",
)
