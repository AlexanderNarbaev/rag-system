...
def compute_confidence (
    query: str, context: str, answer: str, slm_available: bool = False, ) -> ConfidenceReport:
  ...
  try:
    from proxy.app.shared.config import HALLUCINATION_CHECK_ENABLED, NLI_GROUNDING_ENABLED
  except ImportError:
...
async def self_critique_answer (
    query: str, context: str, answer: str, llm_client: Any = None, threshold: float = 3.0, ) -> tuple [
  bool, float, str]:
