...
class RetrievalEvaluator:
  ...
  def evaluate_and_act (
      self, query: str, retrieved_chunks: list [dict [str, Any]], ) -> tuple [float, str, list [dict [str, Any]]]:
    """
    ...
    logger.debug (f"Retrieval eval: confidence={confidence:.3f}, action={action}, "
