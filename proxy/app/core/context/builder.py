...
def deduplicate_chunks (
    chunks_with_scores: list [tuple [dict [str, Any], float]], method: str = "hash", ) -> list [tuple [dict [str, Any], float]]:
  """
...
def group_by_semantic_key (chunks_with_scores: list [tuple [dict [str, Any], float]]) -> list [
...
def reorder_chunks (
    chunks_with_scores: list [tuple [dict [str, Any], float]], ) -> list [tuple [dict [str, Any], float]]:
...
def build_context (
    chunks_with_scores: list [tuple [dict [str, Any], float]], max_tokens: int = 120000, include_metadata: bool = True,
    sort_by_score: bool = True, lang: str | None = None, ) -> str:
  """
...
def prepare_context (
    ...
    max_tokens: int = 120000, deduplicate: bool = True, resolve_versions_flag: bool = True,
    group_semantic: bool = False, lang: str | None = None, ) -> str:
  """
