...
SEARCH_DOCUMENTS_TOOL = ToolDefinition(
    ...
    parameters=[
        ...
        ToolParam(name="top_k", type=int, description="Number of results (default 5)", required=False, default=5),
    ...
    category="search",
    tags=["retrieval", "hybrid", "qdrant"],
)

SEARCH_BY_VERSION_TOOL = ToolDefinition(
    ...
    parameters=[
        ...
        ToolParam(name="top_k", type=int, description="Number of results (default 10)", required=False, default=10),
    ],
    handler=search_by_version,
    category="search",
    tags=["retrieval", "version", "qdrant"],
)

GET_DOCUMENT_METADATA_TOOL = ToolDefinition(
    ...
    category="metadata",
    tags=["retrieval", "metadata", "qdrant"],
)
