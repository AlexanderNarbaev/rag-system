...
def _register_builtin_tools (
    legacy_registry: ToolRegistry | None = None, enhanced_registry: EnhancedToolRegistry | None = None, ) -> None:
  ...
  if legacy_registry is not None:
    legacy_registry.register (ToolDefinition (name = "search_documents",
        ...
        }, handler = search_documents, category = "search", ))
    legacy_registry.register (
        ToolDefinition (name = "search_by_version", description = "Search documents by a specific version string",
            ...
            }, handler = search_by_version, category = "search", ))
    legacy_registry.register (
        ToolDefinition (name = "get_document_metadata", description = "Get metadata for a specific document by its ID",
            parameters_schema = {
                "type": "object", "properties": {
                    "doc_id": {"type": "string", "description": "Document ID (chunk hash)"},
                }, "required": ["doc_id"],
            }, handler = get_document_metadata, category = "metadata", ))
