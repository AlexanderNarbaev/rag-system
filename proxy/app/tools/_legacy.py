...
Tools are registered by name and can be called synchronously.
The registry is a singleton with built-in tools pre-registered.
"""
...
def get_tool_registry () -> ToolRegistry:
  ...
  if _tools_pkg._global_registry is None:
    ...
    if TOOLS_ENABLED:
      _tools_pkg._global_registry.register (ToolDefinition (name = "search_documents",
          ...
          }, handler = _search_documents, category = "search", ))
      _tools_pkg._global_registry.register (
          ToolDefinition (name = "search_by_version", description = "Search documents by a specific version string",
              parameters_schema = {
                  "type": "object", "properties": {
              ...
              }, handler = _search_by_version, category = "search", ))
      _tools_pkg._global_registry.register (ToolDefinition (name = "get_document_metadata",
          description = "Get metadata for a specific document by its ID", parameters_schema = {
              "type": "object", "properties": {
                  "doc_id": {"type": "string", "description": "Document ID (chunk hash)"},
              }, "required": ["doc_id"],
          }, handler = _get_document_metadata, category = "metadata", ))
