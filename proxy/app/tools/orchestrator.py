...
class ToolComposer:
  ...
  def conditional (
    ...
    return ConditionalPattern (condition = condition, true_tool = true_tool, false_tool = false_tool, )
...
def _resolve_dependency_levels (
    tools: list [ToolDefinition], registry: EnhancedToolRegistry, ) -> list [set [str]]:
