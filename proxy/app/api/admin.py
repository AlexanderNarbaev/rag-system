...
async def admin_warmup(
    ...
    with tracer.start_as_current_span("admin.warmup") as span:
        ...
        try:
            ...
            return JSONResponse(status_code=500, content={"status": "error", "message": "Admin operation failed"})
...
async def admin_models_rollback(
    ...
    with tracer.start_as_current_span("admin.rollback") as span:
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail="Admin operation failed") from None
