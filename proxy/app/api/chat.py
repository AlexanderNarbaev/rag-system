...
async def chat_completions(
    ...
    if request.stream:
        ...
        async def event_generator() -> AsyncIterator[str]:
            ...
            try:
                ...
                yield f"data: {json.dumps({'error': 'Knowledge system temporarily unavailable'})}\n\n"
    ...
    from proxy.app.core.hitl import generate_feedback_id
    from proxy.app.core.knowledge_status import determine_knowledge_status
    from proxy.app.shared.config import CLARIFICATION_ENABLED, UNGROUNDED_NOTICE
    ...
    if knowledge_status.status == "absent" and not should_gen:
        # Always keep LLM response — prepend notice about missing knowledge
