...
_PERMISSION_MAP: dict [str, Role] = {
    "admin:config": Role.ADMIN, "admin:users": Role.ADMIN, "admin:stats": Role.ADMIN, "admin:metrics": Role.ADMIN,
    "admin:warmup": Role.ADMIN, "feedback": Role.EXPERT, "feedback:submit": Role.EXPERT, "feedback:review": Role.EXPERT,
    "enrichment:trigger": Role.EXPERT, "chat": Role.USER, "chat:stream": Role.USER, "widget:access": Role.USER,
    "models:list": Role.READ_ONLY, "health:check": Role.READ_ONLY, "auth:login": Role.READ_ONLY,
    "auth:refresh": Role.READ_ONLY, "auth:register": Role.READ_ONLY, "auth:logout": Role.READ_ONLY,
