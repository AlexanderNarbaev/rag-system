...
def batch_load_from_extractor (
    loader: Neo4jLoader, entities: list [dict], relations: list [dict], clear_old: bool = False,
...
if __name__ == "__main__":
  ...
  sample_entities = [
      {
          "id": "abc123", "name": "Иван Иванов", "type": "PERSON", "source_id": "confluence_123",
          "properties": {"role": "developer"},
      }, {
          "id": "def456", "name": "PROJ-123", "type": "PRODUCT", "source_id": "jira_456",
