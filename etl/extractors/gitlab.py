    ...
    for disc in discussions:
      ...
      for note in disc.get ("notes", []):
        notes.append ({
            ...
            "body": note ["body"], "type": note.get ("type", "regular"),  # DiffNote, etc.
        })
...
if __name__ == "__main__":
  ...
  config_example = {
      "url": os.getenv ("GITLAB_URL", "https://gitlab.example.com"), "token": os.getenv ("GITLAB_TOKEN", "your_token"),
      "project_ids": None,  # None → fetch ALL accessible projects; or [1, 2, 3]
      "max_projects": 0,  # 0 = no limit
      "output_dir": "./raw_data/gitlab", "wal_file": "./wal/gitlab_wal.json", "incremental": True,
      "fetch_commits": True, "fetch_files": True, "fetch_merge_requests": True, "max_commits_per_project": 500,
      "since_date": "2025-01-01T00:00:00Z", "file_paths_filter": ["*.py", "*.md", "Dockerfile", "*.yaml", "*.yml"],
      "file_paths_exclude": ["*.java", "*.kt", "*.class", "node_modules/*"],
  }
