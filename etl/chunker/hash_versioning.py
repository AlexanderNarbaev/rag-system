...
class ChunkVersionStore:
    ...
    def get_last_hash(self, doc_id: str) -> Optional[str]:
    ...
    def update_document_chunks(self, doc_id: str, new_chunks: List[Dict], force: bool = False) -> Tuple[List[Dict], List[Dict]]:
        """
    ...
    def _load_hot_chunks(self, doc_id: str) -> List[Dict]:
        ...
        if not doc_hot_path.exists():
            return []
        with open(doc_hot_path, "r", encoding="utf-8") as f:
            return json.load(f)
