...
class TestSemanticChunkerMergeShortChunks:
  def test_merge_short_chunks (self):
    ...
    chunks = [
        Chunk (text = "short", hash = "a", tokens_approx = 10), Chunk (text = "short2", hash = "b", tokens_approx = 20),
...
class TestMDKeyChunkerPackBySemanticKey:
  def test_pack_no_semantic_keys (self):
    ...
    md_key = MDKeyChunker (chunker, enricher)
    chunks = [
        Chunk (text = "a", hash = "a1", source_type = "wiki"), Chunk (text = "b", hash = "b1", source_type = "wiki"),
    ]
...
class TestSaveChunksToJson:
  def test_save_chunks_to_json (self, tmp_path):
    chunks = [
        Chunk (text = "chunk text", hash = "abc123", keywords = ["test"], entities = ["ORG:Acme"],
            hypothetical_questions = ["What is this?"], source_type = "wiki", )
    ]
