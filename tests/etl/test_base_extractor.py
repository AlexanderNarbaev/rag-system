...
class TestExtractorConfig:
  def test_default_values (self):
    config = ExtractorConfig (source_name = "test-source", source_type = "book", base_url = "/data/books", )
  ...
  def test_full_config (self):
    config = ExtractorConfig (source_name = "wiki", source_type = "confluence", base_url = "https://wiki.example.com",
        api_token = "secret-token", max_pages = 500, batch_size = 25, timeout = 60,
...
class TestExtractedDocument:
  def test_minimal_creation (self):
    doc = ExtractedDocument (source_id = "doc-1", source_type = "confluence", title = "Test Page",
        content = "Some content", content_type = "html", )
  ...
  def test_full_creation (self):
    doc = ExtractedDocument (source_id = "doc-2", source_type = "jira", title = "PROJ-123",
        content = "Issue description", content_type = "html", metadata = {"priority": "High", "status": "Open"},
        access_level = "restricted", version = "3", extracted_at = "2025-06-01T00:00:00Z",
...
class TestBaseExtractor:
  class _MockExtractor (BaseExtractor):
    ...
    async def extract (self) -> AsyncIterator [ExtractedDocument]:
      yield ExtractedDocument (source_id = "mock-1", source_type = "mock", title = "Mock", content = "test",
          content_type = "text", )
      return
