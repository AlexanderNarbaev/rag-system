...
from etl.chunker.code_chunker import (
  AST_LANGUAGES, CODE_CHUNKING_ENABLED, CodeChunk, chunk_code, chunk_java, chunk_javascript, chunk_python,
)
...
class TestCodeChunk:
  ...
  def test_creation_with_docstring (self):
    cc = CodeChunk (name = "my_func", code = 'def my_func():\n    """Docs."""\n    pass', language = "python",
        docstring = "Docs.", line_start = 1, line_end = 3, )
