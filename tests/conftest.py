  ...
  return [
      {
          ...
          "hash": "hash_confluence_v1_1", "title": "RAG Overview", "source_type": "confluence",
          "source_id": "confluence_123", "version": "1.0", "doc_title": "Архитектура RAG",
          "keywords": ["RAG", "LLM", "retrieval"], "entities": ["LLM", "RAG"],
          "summary": "RAG объединяет LLM с базой знаний.", "position": 0, "semantic_key": "rag_overview",
      }, {
          "text": "RAG (Retrieval-Augmented Generation) — updated: combines retrieval with generation for accurate "
                  "responses.",
          "hash": "hash_confluence_v2_1", "title": "RAG Overview", "source_type": "confluence",
          "source_id": "confluence_123", "version": "2.0", "doc_title": "Архитектура RAG",
          "keywords": ["RAG", "LLM", "retrieval", "generation"], "entities": ["LLM", "RAG"],
          "summary": "Updated RAG overview.", "position": 0, "semantic_key": "rag_overview",
      }, {
          "text": "Для настройки CI/CD pipeline необходимо создать файл .gitlab-ci.yml в корне репозитория.",
          "hash": "hash_gitlab_mr_1", "title": "CI/CD Setup", "source_type": "gitlab_merge_request",
          "source_id": "gitlab_mr_42", "version": "latest", "doc_title": "CI/CD Configuration Guide",
          "keywords": ["CI/CD", "GitLab", "pipeline"], "entities": ["GitLab", "CI/CD"],
          "summary": "CI/CD pipeline setup instructions.", "position": 0, "semantic_key": "cicd_setup",
      }, {
          "text": "Задача PROJ-123: Интеграция RAG с корпоративным поиском. Приоритет: High.", "hash": "hash_jira_v1_1",
          "title": "Интеграция RAG", "source_type": "jira", "source_id": "jira_PROJ-123", "version": "1.5",
          "doc_title": "PROJ-123", "keywords": ["RAG", "интеграция", "поиск"], "entities": ["RAG", "интеграция"],
          "summary": "Jira task for RAG integration.", "position": 0, "semantic_key": "jira_proj123",
      }, {
          "text": "GitLab commit a1b2c3d: Added hybrid search module using Qdrant.", "hash": "hash_gitlab_commit_1",
          "title": "hybrid search commit", "source_type": "gitlab_commit", "source_id": "gitlab_commit_a1b2c3d",
          "version": "latest", "doc_title": "Commit a1b2c3d", "keywords": ["hybrid", "search", "Qdrant"],
          "entities": ["Qdrant"], "summary": "Added hybrid search module.", "position": 0,
...
def mock_http_requests ():
  ...
  with (
    patch ("requests.get") as mock_get, patch ("requests.post") as mock_post, patch (
...
def sample_documents ():
  ...
  return {
      "confluence": {
          "id": "12345", "title": "RAG Architecture Guide", "space": "DEV", "version": 2,
          "created_at": "2025-01-15T10:00:00", "updated_at": "2025-06-20T14:00:00",
          ...
          "key": "PROJ-123", "summary": "Интеграция RAG с поиском",
          "description": "Необходимо интегрировать RAG систему с корпоративным поиском.", "status": "In Progress",
          "priority": "High", "assignee": "ivanov", "comments": [{"author": "petrov", "body": "Начал разработку."}],
      }, "gitlab": {
          "id": "a1b2c3d4e5f6", "title": "Add hybrid search module",
          "message": "Added hybrid search module using Qdrant with dense and sparse vectors.", "author_name": "ivanov",
