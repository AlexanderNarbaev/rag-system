...
def mock_kb_manager ():
  ...
  manager.create_kb.return_value = KnowledgeBase (
      id = "kb-123", name = "Test KB", description = "Test", collection_name = "kb_test_kb",
  ...
  manager.get_kb.return_value = KnowledgeBase (
      id = "kb-123", name = "Test KB", collection_name = "kb_test_kb",
  )
  # update_kb returns updated KB
  manager.update_kb.return_value = KnowledgeBase (
      id = "kb-123", name = "Updated KB", collection_name = "kb_test_kb",
  )
  ...
  manager.create_task.return_value = ETLTask (
      id = "task-1", kb_id = "kb-123", source_type = "confluence", source_id = "page-1",
  )
  ...
  manager.get_task.return_value = ETLTask (
      id = "task-1", kb_id = "kb-123", source_type = "confluence", source_id = "page-1", status = "completed",
  )
  return manager
