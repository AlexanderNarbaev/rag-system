...
def test_compute_confidence_high ():
  ...
  report = compute_confidence (query = "What is Python?", context = context, answer = answer, slm_available = False, )
...
def test_compute_confidence_low_empty_context ():
  report = compute_confidence (query = "What is XYZ?", context = "", answer = "I don't know about XYZ.",
      slm_available = False, )
  assert report.score < 0.5
...
def test_compute_confidence_low_uncertainty_phrases ():
  report = compute_confidence (query = "Complex question",
      context = "Some relevant context about the topic with enough detail to answer the question properly.",
      answer = "I'm not sure about this, possibly the answer is unclear.", slm_available = False, )
...
def test_compute_confidence_very_short_answer ():
  report = compute_confidence (query = "What is X?", context = "Some context", answer = "Yes.", slm_available = False, )
  assert report.score < 0.7
