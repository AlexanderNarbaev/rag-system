...
class TestEvaluateNLI:
    ...
    def test_overall_score_bounded(self):
        result = evaluate_nli(
            "This is a test claim sentence.",
            "This is a test context with different words entirely.",
            use_real_nli=False,
        )
...
class TestEvaluateNLIBatch:
    ...
    def test_pair_with_empty_answer_contributes_zero(self):
        pairs = [
            ("", "Some context"),
            ("Valid claim sentence here.", "Valid context sentence here."),
        ]
        result = evaluate_nli_batch(pairs, use_real_nli=False)
