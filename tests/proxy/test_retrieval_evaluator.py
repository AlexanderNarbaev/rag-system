...
class TestRetrievalEvaluator:
    ...
    def test_evaluate_quality_returns_0_to_1(self, evaluator):
        chunks = [
            {"text": "relevant content about the query", "score": 0.85},
            {"text": "somewhat related", "score": 0.65},
    ...
    def test_high_similarity_high_confidence(self, evaluator):
        chunks = [
            {"text": "highly relevant text", "score": 0.92},
            {"text": "also very relevant", "score": 0.88},
            {"text": "relevant too", "score": 0.85},
            {"text": "another relevant", "score": 0.82},
        ]
    ...
    def test_low_scores_low_confidence(self, evaluator):
        chunks = [
            {"text": "barely relevant", "score": 0.2},
            {"text": "not very useful", "score": 0.25},
    ...
    def test_mixed_scores_medium_confidence(self, evaluator):
        chunks = [
            {"text": "good match", "score": 0.9},
            {"text": "bad match", "score": 0.1},
            {"text": "ok match", "score": 0.5},
        ]
        score = evaluator.evaluate_quality("test query", chunks)
    ...
    def test_no_scores_uses_text_overlap(self, evaluator):
        chunks = [
            ...
            {"text": "deep neural networks and training"},
    ...
    def test_decompose_chunks_removes_low_score(self, evaluator):
        chunks = [
            {"text": "good content", "score": 0.9},
            {"text": "bad content", "score": 0.05},
    ...
    def test_decompose_chunks_removes_duplicates(self, evaluator):
        chunks = [
            {"text": "same text appears twice", "score": 0.8},
            {"text": "same text appears twice", "score": 0.7},
    ...
    def test_evaluate_and_act_use(self, evaluator):
        chunks = [
            {"text": "great result", "score": 0.9},
            {"text": "also great", "score": 0.88},
        ]
    ...
    def test_evaluate_and_act_fallback(self, evaluator):
        chunks = [
            {"text": "very poor result", "score": 0.01},
            {"text": "also terrible", "score": 0.02},
        ]
        confidence, action, processed = evaluator.evaluate_and_act("q", chunks)
        assert action == "FALLBACK"
        assert processed == []
    ...
    def test_text_overlap_fallback(self, evaluator):
        chunks = [
            ...
            {"text": "javascript for frontend development"},
        ]
