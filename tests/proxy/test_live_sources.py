...
class TestJiraLiveClient:
                    ...
                    "issues": [
                        {
                            ...
                            "key": "DEV-123",
                            "fields": {
                                "summary": "Add RAG integration",
                                "description": "Implement RAG search",
    ...
    async def test_search_jira_api_error_graceful(self, client):
        mock_session = make_mock_session(get_response=make_mock_response(status=503, text_data="Service Unavailable"))
