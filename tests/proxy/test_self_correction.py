...
class TestReorderChunks:
    ...
    def test_reorder_puts_best_at_start_and_end(self):
        chunks = [
            ({"text": "Best content", "score": 0.95}, 0.95),
            ({"text": "Good content", "score": 0.85}, 0.85),
            ({"text": "Medium content", "score": 0.60}, 0.60),
            ({"text": "Low content", "score": 0.30}, 0.30),
        ]
...
class TestCompressWithPerplexity:
    ...
    def test_compress_keyword_fallback(self, optimizer):
        text = (
            "Kubernetes is an open-source platform. It automates deployment. "
