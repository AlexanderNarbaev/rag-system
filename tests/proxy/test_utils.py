...
from proxy.app.shared.utils import (
  chunk_list, compute_hash, estimate_tokens, extract_issue_keys, extract_urls, format_metadata, generate_request_id,
  mask_sensitive_data, now_iso, safe_divide, safe_json_loads, truncate_by_tokens,
)
...
class TestEstimateTokens:
  ...
  def test_tiktoken_available (self):
    ...
    with (
      patch ("proxy.app.shared.utils.TIKTOKEN_AVAILABLE", True), patch (
        "proxy.app.shared.utils.tiktoken") as mock_tiktoken, ):
