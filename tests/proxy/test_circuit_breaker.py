...
def _reset_breakers():
    ...
    from app.circuit_breaker import _breakers, _frozen, reset_all_breakers
...
class TestCircuitBreakerStates:
    ...
    def test_open_rejects_calls_immediately_sync(self):
        from app.circuit_breaker import CircuitBreaker, CircuitBreakerOpenError, State
...
class TestCircuitBreakerMetrics:
    ...
    def test_metrics_defined(self):
        from app.circuit_breaker import circuit_breaker_failures_total, circuit_breaker_state
    ...
    def test_state_gauge_tracks_closed(self):
        from app.circuit_breaker import CircuitBreaker, circuit_breaker_state
...
class TestBreakerRegistry:
    ...
    def test_get_breaker_creates_and_returns(self):
        from app.circuit_breaker import CircuitBreaker, get_breaker, _breakers
    ...
    def test_get_all_breakers(self):
        from app.circuit_breaker import get_all_breakers, get_breaker
    ...
    def test_reset_all_breakers(self):
        from app.circuit_breaker import CircuitBreaker, State, get_breaker, reset_all_breakers
...
class TestCircuitBreakerEdgeCases:
    ...
    def test_multiple_services_independent(self):
        from app.circuit_breaker import CircuitBreaker, State, get_breaker
