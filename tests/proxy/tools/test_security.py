...
def _make_tool (
    name, description = "Test tool", visibility = ToolVisibility.PUBLIC, parameters = None, category = "general",
    tags = None, handler = None, provider = "sdk", ):
  ...
  return ToolDefinition (name = name, description = description, parameters = parameters, handler = handler,
      category = category, tags = tags or [], visibility = visibility, provider = provider, )
