...
class TestToolBuilder:
  ...
  def test_with_param (self):
    ...
    tool_def = (
        ToolBuilder ("sample").with_param ("query", str, "Search query", required = True).with_param ("top_k", int,
                                                                                                      "Max results",
                                                                                                      default =
                                                                                                      5).build ())
  ...
  def test_builder_fluent_chaining (self):
    ...
    tool_def = (ToolBuilder ("fluent").with_description ("A fluent tool").with_param ("query", str, "Query string",
                                                                                      required = True).with_handler (
      h).with_category ("utils").with_tags (["test"]).with_timeout (5.0).with_visibility (
      ToolVisibility.PUBLIC).build ())
...
class TestToolContext:
  ...
  def test_creates_with_fields (self):
    ...
    ctx = ToolContext (user_id = "user_1", user_role = "admin", request_id = "req_1", tool_call_id = "call_1", )
  ...
  def test_get_state_returns_none_for_unknown_key (self):
    ...
    ctx = ToolContext (user_id = "user_1", user_role = "user", request_id = "req_1", tool_call_id = "call_1", )
  ...
  def test_defaults_for_optional_fields (self):
    ...
    ctx = ToolContext (request_id = "req_1", tool_call_id = "call_1", )
