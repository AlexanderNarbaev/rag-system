...
PETSORE_SPEC = {
    "openapi": "3.0.0", "info": {"title": "PetStore API", "version": "1.0.0"}, "paths": {
        "/pets": {
            "get": {
                "operationId": "listPets", "summary": "List all pets", "description": "Returns all pets from the store",
                "tags": ["pets"], "parameters": [
                    {
                        "name": "limit", "in": "query", "description": "Max items to return", "required": False,
                        "schema": {"type": "integer"},
                    }, {
                        "name": "status", "in": "query", "description": "Filter by pet status", "required": False,
                        "schema": {"type": "string", "enum": ["available", "pending", "sold"]},
                    },
                ],
            }, "post": {
                "operationId": "createPet", "summary": "Create a pet", "tags": ["pets"], "requestBody": {
            ...
            "get": {
                "operationId": "getPetById", "summary": "Get a pet by ID", "tags": ["pets"], "parameters": [
                    {
                ...
                "operationId": "deletePet", "summary": "Delete a pet", "tags": ["admin"], "parameters": [
                    {
                        "name": "petId", "in": "path", "required": True, "schema": {"type": "integer"},
...
class TestEndpointFallbackNaming:
  ...
  def test_swagger_2_0_spec_parsing (self):
    ...
    spec = {
        "swagger": "2.0", "info": {"title": "Swagger Petstore", "version": "1.0.0"}, "paths": {
            "/pets": {
                "get": {
                    "operationId": "findPets", "summary": "Find pets", "parameters": [
