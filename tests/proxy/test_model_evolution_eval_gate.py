...
def _gate_config (
    model: str = "test-model", thresholds: list [MetricThreshold] | None = None, require_baseline: bool = False,
    tolerance: float = 0.02, ) -> EvalGateConfig:
  return EvalGateConfig (model_name = model, thresholds = thresholds or [],
      require_baseline_comparison = require_baseline, baseline_regression_tolerance = tolerance, )
