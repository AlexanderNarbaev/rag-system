...
from proxy.app.core.context import (
  build_context, compute_chunk_hash, deduplicate_chunks, estimate_tokens, extract_version_from_query,
  group_by_semantic_key, prepare_context, resolve_versions,
)
...
class TestComputeChunkHash:
  ...
  def test_same_content_same_hash (self):
    chunk = {
        "text": "hello", "source_type": "confluence", "source_id": "X-1", "version": "1.0", "doc_title": "Test",
    }
...
class TestGroupBySemanticKey:
  ...
  def test_groups_by_semantic_key (self):
    chunks = [
        ({"text": "A1", "semantic_key": "sec1"}, 0.9), ({"text": "A2", "semantic_key": "sec1"}, 0.8),
  ...
  def test_merges_texts (self):
    chunks = [
        ({"text": "part1", "semantic_key": "s1"}, 0.9), ({"text": "part2", "semantic_key": "s1"}, 0.8),
    ]
    result = group_by_semantic_key (chunks)
    assert len (result) == 1
  ...
  def test_fallback_to_hash (self):
    chunks = [
        ({"text": "A", "hash": "h1"}, 0.9), ({"text": "B", "hash": "h2"}, 0.8),
    ]
    result = group_by_semantic_key (chunks)
    assert len (result) == 2
  ...
  def test_average_score (self):
    chunks = [
        ({"text": "A", "semantic_key": "s1"}, 1.0), ({"text": "B", "semantic_key": "s1"}, 0.5),
    ]
    result = group_by_semantic_key (chunks)
...
class TestBuildContext:
  ...
  def test_no_metadata (self):
    chunks = [
        ({"text": "Content A"}, 0.9), ({"text": "Content B"}, 0.8),
    ]
...
class TestPrepareContext:
  ...
  def test_full_pipeline (self):
    chunks = [
        (
            {
                "text": "A dup", "source_id": "doc1", "version": "1.0", "source_type": "w", "title": "T",
                "doc_title": "D",
            }, 0.9,
        ), (
            {
            ...
            {
                "text": "B newer", "source_id": "doc1", "version": "2.0", "source_type": "w", "title": "T",
                "doc_title": "D",
            }, 0.85,
        ),
    ]
  ...
  def test_with_semantic_grouping (self):
    chunks = [
        (
            {
                "text": "P1", "semantic_key": "s1", "source_id": "d1", "version": "1", "source_type": "w", "title": "T",
                "doc_title": "D",
            }, 0.9,
        ), (
            {
                "text": "P2", "semantic_key": "s1", "source_id": "d1", "version": "1", "source_type": "w", "title": "T",
                "doc_title": "D",
            }, 0.8,
        ),
    ]
...
class TestLanguageAwareContextAssembly:
  ...
  def test_build_context_accepts_lang (self):
    ...
    chunks = [
        (
            {
                "text": "RAG combines retrieval with generation.", "source_type": "wiki", "title": "RAG",
  ...
  def test_language_instruction_included_for_non_en (self):
    ...
    chunks = [
        (
            {
                "text": "Qdrant is a vector database for RAG systems.", "source_type": "wiki", "title": "Qdrant",
  ...
  def test_multilang_prioritization (self):
    ...
    chunks = [
        (
            ...
            {
                "text": "English context here.", "source_type": "wiki", "title": "EN Doc", "doc_title": "English Guide",
            }, 0.95,
        ),
    ]
    context = build_context (chunks, lang = "de")
