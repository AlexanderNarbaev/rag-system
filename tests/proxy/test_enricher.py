...
def test_extract_qa_pair_positive ():
  ...
  interaction = {
      "query": "What is Docker?", "response": "Docker is a containerization platform.",
...
def test_extract_qa_pair_with_correction ():
  ...
  interaction = {
      "query": "What is Docker?", "response": "Docker is a tool.", "context": "",
  }
...
def test_chunk_qa_pair ():
  qa = {
      "question": "What is Docker?", "answer": "Docker is a containerization platform.", "feedback_id": "fb1",
      "rating": "positive", "context": "",
  }
