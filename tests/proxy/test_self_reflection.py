...
class TestSelfReflectionNode:
  ...
  def test_reflection_returns_state_dict (self):
    ...
    state = {
        ...
        "context": "Docker is a containerization platform released in 2013.", "rewrite_count": 0, "reflection_count": 0,
    }
  ...
  def test_reflection_stops_at_max_depth (self):
    ...
    state = {
        "query": "Question?", "answer": "Weak answer.", "context": "Some context.", "rewrite_count": 0,
        "reflection_count": 2,
    }
    with patch ("proxy.app.shared.config.REFLECTION_ENABLED", True):
      result = self_reflection (state)
  ...
  def test_reflection_with_slm_failure (self):
    ...
    state = {
        "query": "Question?", "answer": "Answer.", "context": "Context.", "rewrite_count": 0, "reflection_count": 0,
    }
  ...
  def test_reflection_empty_answer (self):
    ...
    state = {
        "query": "Query?", "answer": "", "context": "Context.", "rewrite_count": 0, "reflection_count": 0,
    }
    result = self_reflection (state)
  ...
  def test_reflection_multi_hop_verification (self):
    ...
    state = {
        ...
        "context": "Docker networking uses bridge networks by default. Overlay networks enable multi-host "
                   "communication in Docker Swarm.",
        "rewrite_count": 0, "reflection_count": 0,
    }
    with patch ("proxy.app.llm.slm._call_slm_sync", return_value = "FULLY_SUPPORTED"):
      with patch ("proxy.app.shared.config.REFLECTION_ENABLED", True):
        result = self_reflection (state)
