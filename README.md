...
- ✅ Cross-encoder reranking — BGE-Reranker-v2-m3 with fine-tuning support (upgraded from MiniLM-L-6-v2)
- ✅ Contextual Retrieval — chunks include surrounding paragraph context for improved relevance
...
- ✅ Semantic cache — intelligent similarity-based caching with multi-tier TTL
- ✅ RAGAS metrics — automated evaluation (faithfulness, relevancy, precision, recall)
...
- ✅ Team state persistence — wave tracking, FR completion, project metrics in .rag-team/
