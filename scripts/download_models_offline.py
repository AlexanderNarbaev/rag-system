...
def main():
    ...
    parser.add_argument("--models", nargs="+",
                        choices=["embedder", "reranker", "spacy", "slm", "llm_gguf"],
                        default=["embedder", "reranker", "spacy"],
                        help="Which model types to download")
    parser.add_argument("--embedder-model", type=str, default="",
                        help="Embedding model name (e.g. BAAI/bge-m3)")
    parser.add_argument("--reranker-model", type=str, default="",
                        help="Reranker model name (e.g. cross-encoder/ms-marco-MiniLM-L-6-v2)")
    parser.add_argument("--spacy-model", type=str, default="",
                        help="spaCy model name (e.g. ru_core_news_sm)")
    parser.add_argument("--slm-model", type=str, default="",
                        help="Small Language Model HF ID (e.g. google/gemma-2b-it)")
    parser.add_argument("--gguf-url", type=str, default="",
                        help="URL for GGUF LLM download")
    parser.add_argument("--gguf-output", type=str, default="llm-model.gguf",
                        help="Output filename for GGUF file")
