...
helm upgrade --install rag-system ./rag-system \
  ...
  --set secrets.CHANGE_ME=$(openssl rand -hex 16) \
  --wait \
  --timeout 10m
...
secrets:
  ...
  CHANGE_ME: ""       # Set via --set or sealed-secrets
...
minio:
  ...
  ports:
    ...
    - "9001:9001"
  environment:
    - MINIO_ROOT_USER=${MINIO_ACCESS_KEY:-CHANGE_ME}
    - MINIO_ROOT_PASSWORD=${MINIO_SECRET_KEY:-CHANGE_ME}
...
mlflow:
  ...
  environment:
    ...
    - AWS_ACCESS_KEY_ID=${MINIO_ACCESS_KEY:-CHANGE_ME}
    - AWS_SECRET_ACCESS_KEY=${MINIO_SECRET_KEY:-CHANGE_ME}
