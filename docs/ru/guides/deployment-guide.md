...
## 2. Быстрое развёртывание Docker Compose (разработка / односервер)
...
## 4. Развёртывание Kubernetes с Helm
