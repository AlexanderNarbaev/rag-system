...
ETL-пайплайн (Extract, Transform, Load) загружает данные из корпоративных источников знаний в RAG-систему. Работает как
отдельный процесс, на выделенной ETL-машине, отдельно от прокси-слоя.
