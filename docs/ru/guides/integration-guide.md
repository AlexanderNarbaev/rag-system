...
**Статус реализации:** Реализовано. RAG-система предоставляет OpenAI-совместимый API, встраиваемый чат-виджет, Tools SDK
и MCP-сервер для интеграции с IDE.
...
Типы данных автоматически конвертируются в JSON Schema. Имя функции становится именем инструмента, строка документации —
описанием.
