...
**Версия:** v0.4.0 | **Тесты:** 505 всего, 483 проходят (96%) | **Зрелость:** RAG Level 4 (Agentic) работает, Level 5 (Self-Correcting) частично спроектирован

[Быстрый старт](#_3){ .md-button .md-button--primary }
...
| Тестирование | 4,5/10 | 10 | 45% |
| Безопасность | 5/10 | 10 | 50% |
| Наблюдаемость | 4/10 | 10 | 40% |
| Надёжность | 5/10 | 10 | 50% |
| Производительность | 5,5/10 | 10 | 55% |
| Эксплуатация | 3,5/10 | 10 | 35% |
| Документация | 9/10 | 10 | 90% |
| **В целом** | **42,5/80** | **80** | **53%** |
