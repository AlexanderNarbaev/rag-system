# model_evolution_service/trainers/slm.py
...
class SLMTrainer(TrainerBase):
    ...
    def prepare_data(
        ...
        return {
            "train": [valid[i] for i in indices[:split_idx]],
            "eval": [valid[i] for i in indices[split_idx:]],
        }
    ...
    def train(self, config: TrainingConfig) -> TrainingJob:
        ...
        try:
            ...
            model = AutoModelForSequenceClassification.from_pretrained(
                config.base_model or "bert-base-uncased",
